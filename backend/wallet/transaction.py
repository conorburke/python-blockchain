...
class Transaction:
    ...
    def create_input(self, sender_wallet, output):
        """
        Structe the input data for the transaction
    ...
    def from_json(transaction_json):
        ...
        # return Transaction(id=transaction_json['id'], input=transaction_json['input'], output=transaction_json['output'])
        return Transaction(**transaction_json)

    @staticmethod
    def is_valid_transaction(transaction):
        """
        Validate a transcation and raise an exception for invalid transactions
        """
